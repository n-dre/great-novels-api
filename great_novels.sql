...
CREATE USER 'novel'@'localhost' IDENTIFIED WITH mysql_native_password BY '4218';

GRANT ALL ON novel.* TO 'novel'@'localhost';
...
CREATE TABLE genres (
    ...
    name VARCHAR(255),
    type ENUM('Fiction', 'Horror', 'Fantasy', 'Gothic', 'Historical Fiction', 'Drama', 'Plays', 'Adventure', 'Mystery', 'Science Fiction', 'Russian Literature','Dystopia', 'Time Travel', 'African Literature'),
